...
<head>
  ...
  <title>zSkillers | 10 HP Clan</title>
  ...
  <!-- Less -->
  <link href="{{ asset("/bower_components/bootstrap/dist/css/less/navbar.less")}}" rel="stylesheet" type="text/css" />
  <!-- Font Awesome -->
...
<div class="wrapper" id="app">
  ...
  <header class="main-header">
    ...
    <a href="../../index2.html" class="logo">
      ...
      <span class="logo-lg">-<b>z</b>Skillers-</span>
    </a>
